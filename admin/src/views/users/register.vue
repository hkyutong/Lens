...
<script lang="ts" setup>
  ...
  const rules = ref<FormRules>({
    ...
    signInModel3Count: [{ required: true, trigger: 'blur', message: '请填写赠送的基础额度' }],
    signInModel4Count: [{ required: true, trigger: 'blur', message: '请填写赠送的高级额度' }],
  ...
  <div>
    ...
    <el-card style="margin: 20px">
      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="220px">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="赠送基础额度" prop="signInModel3Count">
              <el-input
                v-model="formInline.signInModel3Count"
                type="number"
                placeholder="请填写签到赠送的基础额度"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="赠送高级额度" prop="signInModel4Count">
              <el-input
                v-model="formInline.signInModel4Count"
                type="number"
                placeholder="请填写签到赠送的高级额度"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="基础额度" prop="visitorModel3Num">
              <el-input
                v-model="formInline.visitorModel3Num"
                type="number"
                placeholder="请填写每日限制普通积分"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="高级额度" prop="visitorModel4Num">
              <el-input
