...
<script lang="ts" setup>
  ...
  const rules = ref<FormRules>({
    ...
    drawMjName: [{ required: true, message: '请输入顶级积分名称', trigger: 'blur' }],
  });
  ...
  <div>
    ...
    <el-card style="margin: 20px">
      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="150px">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="隐藏顶级积分" prop="isHideDrawMjPoint">
              <el-switch
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="顶级积分名称" prop="drawMjName">
              <el-input v-model="formInline.drawMjName" placeholder="顶级积分名称" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
