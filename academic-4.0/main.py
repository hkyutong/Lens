...
"""[📖详细教程📖](https://docs.qq.com/pdf/DWXFoemRiTFVTUHdI)
</br></br>对话使用说明: 1. 输入问题➡️ 2. 点击提交
</br></br>基础使用说明: 1. 输入文本➡️ 2. 点击任意基础功能区按钮"
</br></br>插件使用说明: 1. 输入路径/问题，或者上传文件➡️ 2. 再点击任意函数插件区按钮
</br></br>虚空终端说明: 1. 点击虚空终端，然后根据提示输入指令➡️ 2 再次点击虚空终端
</br></br>保存对话说明: 1. 点击保存当前的对话➡️ 2. 点击返回的链接打开后保存到你的电脑本地"""
...
def main():
    ...
    title_html = f"<h1 align=\"center\">GPT-5 学术优化"
        ...
        with gr_L1():
            ...
            with gr_L2(scale=1, elem_id="gpt-panel"):
                with gr.Accordion("输入区", open=True, elem_id="input-panel") as area_input_primary:
                    ...
                    with gr.Row():
                        status = gr.Markdown(f"**获取支持 yutogpt@gmail.com**", elem_id="state-panel")
