...
def extract_archive(file_path, dest_dir):
    ...
    normalized_name = os.path.basename(normalized_path).lower()
    ...
    elif normalized_name.endswith((".tar", ".tar.gz", ".tgz", ".tar.bz2", ".tbz2", ".gz", ".bz2", ".xz", ".tar.xz", ".txz")):
        try:
            ...
            if normalized_name.endswith((".gz", ".tgz", ".tar.gz")):
    ...
    elif normalized_name.endswith(".rar"):
        try:
