    ...
    extend: {
      ...
      colors: {
        ...
        input: {
          ...
          borderColor: '#ebe7e2',
          borderStyle: 'solid',
          '::placeholder': { color: '#9c948e' },
          '&:hover:not(:disabled)': { borderColor: '#dad3cc' },
          '&:focus:not(:disabled)': {
            borderColor: '#080808',
            boxShadow: '0 0 0 2px rgba(8, 8, 8, 0.2)',
          },
          '&.is-error': {
            borderColor: '#ef4444',
      ...
      addComponents({
        ...
        '.btn-secondary': {
          ...
          '&:hover:not(:disabled)': {
            ...
            borderColor: 'var(--btn-border-secondary-hover)',
          },
          '&:active:not(:disabled)': {
            backgroundColor: 'var(--btn-bg-secondary-active)',
            borderColor: 'var(--btn-border-secondary-active)',
          },
          '.dark &': {
            backgroundColor: 'var(--btn-bg-secondary)',
            color: 'var(--btn-text-secondary)',
        ...
        '.btn-send': {
          ...
          '.dark &': {
            backgroundColor: '#1b2f55',
            color: '#ffffff',
            '&:hover:not(:disabled)': {
              backgroundColor: '#243a66',
            },
            '&:disabled': {
              backgroundColor: '#2f2f2f',
            },
