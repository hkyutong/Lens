...
function http<T = any>({
  ...
  const isUrlSearchParams =
    typeof URLSearchParams !== 'undefined' && requestData instanceof URLSearchParams
  const isBlob = typeof Blob !== 'undefined' && requestData instanceof Blob
  const isArrayBuffer = typeof ArrayBuffer !== 'undefined' && requestData instanceof ArrayBuffer
  const isRawBody = isFormData || isUrlSearchParams || isBlob || isArrayBuffer
  const params =
